...
namespace ExamineSystem.utility.eslog
{
    public class ESLogManager
    {
        ...
        public static IESLog Exists(string name)
        {
        ...
        /// <param name="name">The fully qualified logger name to look for</param>
        /// <returns>The logger found, or null</returns>
        public static IESLog Exists(string domain, string name)
        {
        ...
        /// <param name="name">The fully qualified logger name to look for</param>
        /// <returns>The logger found, or null</returns>
        public static IESLog Exists(Assembly assembly, string name)
        {
        ...
        public static IESLog[] GetCurrentLoggers()
        {
        ...
        /// </remarks>
        /// <returns>All the defined loggers</returns>
        public static IESLog[] GetCurrentLoggers(string domain)
        {
        ...
        /// </remarks>
        /// <returns>All the defined loggers</returns>
        public static IESLog[] GetCurrentLoggers(Assembly assembly)
        {
        ...
        public static IESLog GetLogger(string name)
        {
        ...
        /// <param name="name">The name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static IESLog GetLogger(string domain, string name)
        {
        ...
        /// <param name="name">The name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static IESLog GetLogger(Assembly assembly, string name)
        {
        ...
        /// <returns>the logger with the name specified</returns>
        public static IESLog GetLogger(Type type)
        {
        ...
        /// be used as the name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static IESLog GetLogger(string domain, Type type)
        {
        ...
        /// be used as the name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static IESLog GetLogger(Assembly assembly, Type type)
        {
        ...
        private static IESLog WrapLogger(ILogger logger)
        {
            return (IESLog)s_wrapperMap.GetWrapper(logger);
        }
        ...
        private static IESLog[] WrapLoggers(ILogger[] loggers)
        {
            IESLog[] results = new IESLog[loggers.Length];
