<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/master/Default.Master" CodeBehind="pagehistoryadv.aspx.cs" Inherits="ExamineSystem.pagehistoryadv" %>
...
<script language="JavaScript">
    ...
    function DelRecord(hisid) {
        if (confirm("您真的要删除此记录及其所选记录吗？\n删除后将无法恢复")) {
            ...
            parent.left.LoadDocFunc("删除历史记录", "pagehistoryadv?type=delhistory&id=" + hisid + "&PageN=" + currentPageNum, RunFunc);
        }
    }
    ...
    function history(userid, username, usernum) {
        ...
        parent.left.LoadDocFunc("读取用户历史记录", "pagehistoryadv?type=historylist&pagenum=1", RunFunc, null, userid);
    }
    ...
    function showCurrentPageFunc(nameStr, Num) {
        ...
        if (ObjName.indexOf("SysHistoryListPages") == 0) {
            ...
            parent.left.LoadDocFunc("读取用户历史记录", "pagehistoryadv?type=historylist&pagenum=" + PageNum, RunFunc);
        }
    }
    ...
    function showAllContent(nameStr, that) {
        ...
        if (ObjName.indexOf("SysHistoryListPages") == 0) {
            if (that.value == "呈现全部") {
                ...
                parent.left.LoadDocFunc("读取用户历史记录", "pagehistoryadv?type=historylist&pagenum=0", RunFunc);
                that.value = "恢复分页";
            }
            else {
                var TmpPageNumT = SysHistoryListPages.page;
                var RunFunc = ["CreateHistoryList(" + TmpPageNumT + ");"];
                parent.left.LoadDocFunc("读取用户历史记录", "pagehistoryadv?type=historylist&pagenum=" + TmpPageNumT, RunFunc);
                that.value = "呈现全部";
            }
        }
    }
...
<script language="javascript">
    ...
    function SearchFunc(sign) {
        ...
        parent.left.LoadDocFunc("快速搜索历史记录", "pagehistoryadv?type=search&sign=" + Sign, RunFunc, null, TxtStr);
    }
    ...
    function changeSearchNormal() {
        ...
        parent.left.LoadDocFunc("恢复历史记录列表", "pagehistoryadv?type=reviece&pagenum=" + StatusPage, RunFunc);
    }
...
<script language="javascript">
    function BetterSearchClass() {
        ...
        this.RunSearch = function () {
            ...
            ListPageFunc();
            var RunFunc = new Array("SearchFuncRun();");
            parent.left.LoadDocFunc("搜索相关历史记录", "pagehistoryadv?type=search&sign=3", RunFunc, null, BackTxt);
        }
    }
  ...
  <table border="0" cellpadding="0" cellspacing="0" class="TableStyle">
    <tr>
      <td height="22" align="center" class="HeadStyle"><span id="hisnam">历史分数记录</span></td>
    </tr>
    <tr>
